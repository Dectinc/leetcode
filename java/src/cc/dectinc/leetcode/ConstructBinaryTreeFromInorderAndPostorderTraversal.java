...
public class ConstructBinaryTreeFromInorderAndPostorderTraversal {
	...
	public TreeNode buildTree(int[] inorder, int[] postorder) {
		...
		return buildTree(inorder, postorder, 0, length - 1, 0,
				postorder.length - 1);
	}
	...
	public TreeNode buildTree(int[] inorder, int[] postorder, int inStart,
		...
		curRoot.left = buildTree(inorder, postorder, inStart, rootIndex - 1,
				postStart, postStart + rootIndex - inStart - 1);
		curRoot.right = buildTree(inorder, postorder, rootIndex + 1, inEnd,
